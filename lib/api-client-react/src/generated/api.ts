 ...
 */
export const signup = async (signupInput: SignupInput, options?: RequestInit): Promise<ProfileView> => {

  return customFetch<ProfileView>(getSignupUrl(),
  {
    ...options,
    method: 'POST',
 ...
 */
export const login = async (loginInput: LoginInput, options?: RequestInit): Promise<ProfileView> => {

  return customFetch<ProfileView>(getLoginUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
