            ...
            <form onSubmit={form2.handleSubmit(onStep2Submit)} className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-1.5 max-h-28 overflow-y-auto p-2 border rounded-md bg-muted/30">
                  {(Array.isArray(allSkills) ? allSkills : []).filter((s) => typeof s === 'string' && !selectedSkills.includes(s)).map((skill) => (
              ...
              <div className="space-y-2">
                ...
                <Input {...form2.register("linkedinUrl")} placeholder="https://www.linkedin.com/in/your-name" />
                ...
                {form2.formState.errors.linkedinUrl && (
                  <p className="text-sm text-destructive">{form2.formState.errors.linkedinUrl.message}</p>
                )}
              </div>
              <div className="space-y-2">
